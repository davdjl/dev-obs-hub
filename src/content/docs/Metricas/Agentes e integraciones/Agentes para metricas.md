...
* En la mayoría de los casos estos agentes no almacenan información, solo recolectan y envían la data, pero debemos tener en consideración si tienen habilitados una queue de eventos en caso de que el destino de la información no pueda recibir la data.
## Tiempo de ejecución
